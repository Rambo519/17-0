...
describe("stochastic season variance", () => {
  ...
  it("keeps expected wins and perfect-season chance independent of the season seed", () => {
    for (const rating of [76, 84, 86.7, 87, 88.5, 90.8]) {
      ...
      expect(seeded.perfectSeasonProbability).toBeCloseTo(
        seeded.perGameWinProbability ** WIN_PROJECTION_MODEL.seasonLength,
        12,
      );
    }
  });
